...
import ru.henridellal.emerald.adapter.CustomAdapter;
import ru.henridellal.emerald.background.AppsTask;
import ru.henridellal.emerald.background.AppsTaskLollipop;
import ru.henridellal.emerald.background.GetAppsThread;
import ru.henridellal.emerald.data.AppData;
import ru.henridellal.emerald.data.BaseData;
import ru.henridellal.emerald.data.Category;
