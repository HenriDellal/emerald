...
public class ChangeIconActivity extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final File customIconFile = Cache.getCustomIconFile(this, component);
	...
	public void onClick(View v) {
		switch (v.getId()) {
			case R.id.reset_icon:
				File customIconFile = Cache.getCustomIconFile(this, component);
	...
	public void saveCustomIcon(String appComponent, Uri fileUri) {
		File customIconFile = Cache.getCustomIconFile(this, appComponent);
		try {
